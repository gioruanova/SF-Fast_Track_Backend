exports.seed = async function (knex) {
  ...
  await knex("companies_config").insert([
    {
      // ejemplo de seeder configuracion
      // este seed es necesario unicamente para dev. el codigo ya hace una pre carga de configuraciones por defecto en la base de datos
