...
router.put(
  ...
  publicMessagesController.markMessageAsReadAsAdmin
);
router.put(
  "/messages/unread/:message_id",
  publicMessagesController.markMessageAsUnreadAsAdmin
);
router.delete(
  "/messages/:message_id",
  publicMessagesController.deleteMessageAsAdmin
);

// Categorias mensajes publicos
router.get(
  "/messageCategories",
  publicMessageCategoryController.getAllMessagesCategoriesAsAdmin
);
router.post(
  "/messageCategories",
  publicMessageCategoryController.createMessageCategoryAsAdmin
);
router.put(
  "/messageCategories/:category_id",
  publicMessageCategoryController.updateMessageCategoryAsAdmin
);
router.put(
  "/messageCategories/disable/:category_id",
  publicMessageCategoryController.disableMessageCategoryAsAdmin
);
router.put(
  "/messageCategories/enable/:category_id",
  publicMessageCategoryController.enableMessageCategoryAsAdmin
);

router.delete(
  "/messageCategories/:category_id",
  publicMessageCategoryController.deleteCategoryMessageAsAdmin
);
...
router.get(
  "/especialidades",
  especialidadController.getAllEspecialidadesAsAdmin
);
router.get(
  "/especialidades/:company_id",
  especialidadController.getAllEspecialidadesByCompanyAsAdmin
);

router.post(
  "/especialidades",
  especialidadController.createEspecialidadAsAdmin
);
router.put(
  "/especialidades/:especialidadId",
  especialidadController.updateEspecialidadAsAdmin
);

router.put(
  "/especialidades/block/:especialidadId",
  especialidadController.disableEspecialidadAsAdmin
);
router.put(
  "/especialidades/unblock/:especialidadId",
  especialidadController.enableEspecialidadAsAdmin
);

router.post(
  "/profesionalEspecialidad",
  profesionalEspecialidadController.assignEspecialidadAsAdmin
);
router.delete(
  "/profesionalEspecialidad/:id_asignacion",
  profesionalEspecialidadController.deleteEspecialidadAsAdmin
);
router.put(
  "/profesionalEspecialidad/:id_asignacion",
  profesionalEspecialidadController.editAsignacionEspecialidadAsAdmin
);
...
router.get(
  "/reclamos/:company_id",
  reclamoController.getReclamosByCompanyAsAdmin
);
...
router.get(
  ...
  globalLogController.getAllLogsByCompanyAsAdmin
);
...
router.post(
  ...
  messageController.createMessageForCompanyAsAdmin
);
router.post(
  "/platform/messages/user/:user_id",
  messageController.createMessageForUserAsAdmin
);
router.delete(
